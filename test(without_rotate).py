...
# Demodulation window with two controls (number of zeros + update button) and three plots
class DemodulationWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        # --- Block for zero padding control ---
        ...
        # Добавляем элементы в layout с равной растяжкой
        ...
        # Calculate analytic signal for demodulation
        ...
        # Build default spectrum (without zero padding)
    ...
    def update_spectrum(self):
        ...
        # Pad the demodulated signal with zeros
...
class AdvancedInterferometerApp(QMainWindow):
    ...
    def load_data(self):
        """Load data with error handling and support for CSV, Excel, and TXT files"""
        ...
        if file_name:
            try:
                ...
                if file_name.endswith('.csv'):
                    ...
                    # Optimized converter for txt files
                    try:
    ...
    def init_analysis_controls(self):
        ...
        # Button to open Demodulation window (with integrated zero padding)
